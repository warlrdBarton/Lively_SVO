...
#include "svo/direct/EdgeDrawer.h"
...
ELSED::ELSED(const svo::SegmentDetectorOptions &options){

  params.ksize=options.ksize;
  params.sigma=options.sigma;
  params.gradientThreshold=options.gradientThreshold;
  params.anchorThreshold=options.anchorThreshold;
  params.scanIntervals=options.scanIntervals;
  params.minLineLen=options.minLineLen;
  params.lineFitErrThreshold=options.lineFitErrThreshold;
  params.pxToSegmentDistTh=options.pxToSegmentDistTh;
  params.junctionEigenvalsTh = options.junctionEigenvalsTh;
  params.junctionAngleTh = options.junctionAngleTh;
  params.validationTh = options.validationTh;
  params.validate = options.validate;
  params.treatJunctions = options.treatJunctions;
  params.listJunctionSizes = options.listJunctionSizes;
}
